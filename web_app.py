...
@app.get("/health")
def health():
    required=["TRIGGER_TOKEN","ASTER_URL","ASTER_USERNAME","ASTER_PASSWORD","ASTER_USERNAME_SELECTOR","ASTER_PASSWORD_SELECTOR","ASTER_LOGIN_BUTTON_SELECTOR","ASTER_REPORT_URL","ASTER_REPORT_DOWNLOAD_SELECTOR","ASTER_REPORT_START_DATE_SELECTOR","ASTER_REPORT_END_DATE_SELECTOR","SHEETS_V2_URL","SHEETS_V2_TOKEN"]
